...
const OrderTable = () => {
  ...
  const [filterdOrders, setFilteredOrders] = useState(orderData.orders);
  interface orderType {
    id: string;
    client: string;
    email: string;
          ...
          <thead>
            <tr>
              {[
                ...
                <th className="px-3 md:px-6 py-2 md:py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wider hidden md:table-cell">
                  {header}
                </th>
              ))}
            </tr>
