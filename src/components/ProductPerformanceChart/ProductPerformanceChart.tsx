...
const ProductPerformanceChart = () => {
  const [productPerormanceData, SetProductPerormanceData] = useState([]);

  useEffect(() => {
    fetch("/data/data.json")
      .then((res) => res.json())
      .then((data) => SetProductPerormanceData(data.productPerformance));
  }, []);
  return (
    <motion.div
    ...
    >
      ...
      <div className="w-full h-64 md:h-72">
        <ResponsiveContainer>
          <BarChart data={productPerormanceData}>
